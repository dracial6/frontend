...
import { Color, Size, Rectangle, Point } from "../../drawing/structures";
import IGeomMarking from "./IGeomMarking";
import ContainerGeneralItem from "../common/items/ContainerGeneralItem";
...
class TSlot extends TBaseGeneral implements IGeomMarking {
    ...
    private drawMark(ctx: CanvasRenderingContext2D): void {
        ...
        geomSlotMark.attribute.lineThick = 3 * this.zoomRatioInfo.zoomRatio + this._lineThick;
