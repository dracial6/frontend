...
class DrawLayerHandler {
    ...
    addLayer(layer: DrawLayer, displayLayer: DisplayLayer): void {
        ...
        this._sortedLayerMap = new Map([...Array.from(this._sortedLayerMap.entries())].sort());
    }
    ...
    clearMemoryCache(): void {
        ...
        layerKeys.forEach(layerKey => {
            const list = SearchUtil.getGeometryListByMemberPoint(this.getDrawLayer(layerKey).getDrawList(), 'currentLocation', true, true, undefined);
    ...
    getDrawList(layer: DisplayLayer, memberName: string, visible: boolean | undefined, deepSearch: boolean): IDrawableGeometry[] {
        return SearchUtil.getGeometryListByMemberPoint(this.getDrawLayer(layer).getDrawList(), memberName, visible, deepSearch, undefined);
    }
