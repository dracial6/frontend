...
import QCSideCabinItem from "./items/QCSideCabinItem";

class TCabin extends DrawableObject {
    constructor(name: string, item: QCSideCabinItem, startX: number, startY: number) {
        super(name);
