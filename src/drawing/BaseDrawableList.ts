...
abstract class BaseDrawableList {
    ...
    findAtPoint(point: Point): IDrawableGeometry[] {
        const returnList: IDrawableGeometry[] = [];
    ...
    getGeometryList(memberName: string, visible: boolean | undefined, deepSearch: boolean): IDrawableGeometry[] {
        return SearchUtil.getGeometryListByMemberPoint(this.getDrawList(), memberName, visible, deepSearch, undefined);
    }
    
    getDrawObjectAll(): IDrawableGeometry[] {
        return SearchUtil.getGeometryListByMemberPoint(this.getDrawList(), "IDrawableGeometry", undefined, true, undefined);
    }

    getDrawObjectAllVisible(visible: boolean): IDrawableGeometry[] {
        return SearchUtil.getGeometryListByMemberPoint(this.getDrawList(), "IDrawableGeometry", visible, true, undefined);
    }
