...
class ShipUtil {
    ...
    static invalidateVesselDefineData(vesselDefine: VesselDefine) {
        if (vesselDefine == null) return true;
        if (vesselDefine.vslBays == null) return true;
        if (vesselDefine.vslHatchs == null) return true;
        if (vesselDefine.vslParticular == null) return true;
